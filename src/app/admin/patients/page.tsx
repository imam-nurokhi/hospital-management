  ...
  return (
    <div className="min-h-screen bg-[#f6f9fc] p-6 lg:p-8">
      <div className="hospital-grid-surface mb-6 rounded-[28px] p-6 text-white shadow-xl shadow-blue-950/15 lg:p-8">
        <p className="hospital-pill inline-flex px-4 py-2 text-xs font-bold uppercase tracking-widest">Patient service preview</p>
        <h1 className="mt-5 text-4xl font-black lg:text-5xl">Patient <span className="text-emerald-400">registry</span></h1>
        <p className="mt-4 max-w-3xl text-sm leading-6 text-blue-50">Dummy list untuk validasi alur duplicate checker sebelum DB patient-service siap.</p>
      </div>

      {registry.duplicateWarnings.length > 0 && (
        <div className="mb-6 rounded-3xl border border-rose-200 bg-rose-50 p-4 shadow-sm">
