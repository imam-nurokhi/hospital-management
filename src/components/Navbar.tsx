      ...
      <div className="live-nav-inner">
        <div className="flex items-center justify-between">
          ...
          <Link href="/" className="flex items-center gap-3">
            <div className={`flex h-11 w-11 flex-shrink-0 items-center justify-center rounded-xl shadow-lg transition-colors ${scrolled ? "bg-[#174a7e]" : "bg-[#1a7cc7]"}`}>
          ...
          <ul className="hidden lg:flex items-center gap-1">
            {links.map(l => (
              <li key={l.href}>
                <a href={l.href} className={`rounded-full px-[14px] py-2 text-[15px] font-semibold transition-colors hover:bg-white/10 ${scrolled ? "text-gray-700 hover:text-[#174a7e]" : "text-white/90 hover:text-white"}`}>
                  {l.label}
                </a>
              </li>
            ))}
          ...
          <div className="flex items-center gap-3">
            <a href="#appointment" className="hospital-cta hidden items-center gap-3 rounded-full px-7 py-[13px] text-[15px] font-semibold transition-colors sm:flex">
